 ...
 * @author eugenio
 */
@WebServlet(name = "per", urlPatterns = {"/per"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                rs = st.executeQuery("SELECT * FROM `destinos`;");
                while (rs.next()) {
                    ...
                    out.print("<tr>"
                            ...
                            + "<td>"
                            + "  <a href=\"editarCliente.jsp?id="+ rs.getString(1) + "&nombre=" + rs.getString(2) + "&precio=" + rs.getString(3) + "\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i></a>"
