                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo"><a href="index.jsp">SkyRoute</em></a></div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-offset-0 text-left">
                            ...
                            <div class="row row-mt-10em">
                                <div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                    <h1><center>COMO DESEAS INGRESAR</BR></h1>	
                                </div>
                            </div>
                            <center>
                                <div class="row">
                                    <div class="span12">
                                        <div class="caption">
                                            <div class="well well-small btn btn-primary"  >
                                                <a href="LoginUsuarios.jsp"<h1<div style="text-align: center;"><h2> Cliente</h2><<i class="fa fa-user-circle-o" aria-hidden="true"></i>></div></h1></a>
                                ...
                                <center>
                                    <div class="row">
                                        <div class="span12">
                                            <div class="caption">
                                                <div class="well well-small btn btn-primary" >
                                                    <a href="Login.jsp"<h1><div style="text-align: center;"><h2> Administrador</h2><i class="fa fa-user-secret" aria-hidden="true"></i></div></h1></a>
                                                    <hr class="soft"/>
                                                    <div class="row-fluid">
                                                    </div>
                                                </div>
