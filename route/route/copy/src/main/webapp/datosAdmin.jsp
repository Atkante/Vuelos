...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-sm">
                    <form action="datosAdmin.jsp" method="post">
                        ...
                        <a href="loginA.jsp" class="btn btn-danger">Cancelar</a>
                    </form>
                </div>
            </div>
        </div>
    ...
    <%
        if (request.getParameter("guardar") != null) {
            ...
            if (password1.equals(password2)) {
                ...
                out.print(" <div class=\"alert alert-danger\" role= \"alert\">Contraseña no coincide</div>");
            }
        }
    %>
</html>